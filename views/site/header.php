    ...
    <div class="col-md-3 top-nav">
        ...
        <div class="top-menu">
            ...
            <ul class="cl-effect-16">
                ...
                <li><a href="../../index.php" data-hover="Grids">Grids</a></li>
                <li><a href="../../index.php" data-hover="Services">Services</a></li>
                <li><a href="../../index.php" data-hover="Gallery">Gallery</a></li>
                <li><a href="../../index.php" data-hover="CONTACT">Contact</a></li>
            </ul>
            <!-- script-for-nav -->
            <script>
