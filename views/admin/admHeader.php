...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/template/admin/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- Custom CSS -->
    <link href="/template/admin/css/style.css" rel='stylesheet' type='text/css' />
    <!-- font CSS -->
    <!-- font-awesome icons -->
    <link href="/template/admin/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome icons -->
    <!-- js-->
    <script src="/template/admin/js/jquery-1.11.1.min.js"></script>
    <script src="/template/admin/js/modernizr.custom.js"></script>
    <!--webfonts-->
    <link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' rel='stylesheet' type='text/css'>
    <!--//webfonts-->
    <!--animate-->
    <link href="/template/admin/css/animate.css" rel="stylesheet" type="text/css" media="all">
    <script src="/template/admin/js/wow.min.js"></script>
    <script>
        new WOW().init();
    </script>
    <!--//end-animate-->
    ...
    <!-- //chart -->
    <!--Calender-->
    <link rel="stylesheet" href="/template/admin/css/clndr.css" type="text/css" />
    <script src="/template/admin/js/underscore-min.js" type="text/javascript"></script>
    <script src= "/template/admin/js/moment-2.2.1.js" type="text/javascript"></script>
    <script src="/template/admin/js/clndr.js" type="text/javascript"></script>
    <script src="/template/admin/js/site.js" type="text/javascript"></script>
    <!--End Calender-->
    <!-- Metis Menu -->
    <script src="/template/admin/js/metisMenu.min.js"></script>
                ...
                <ul class="nofitications-dropdown">
                    <li class="dropdown head-dpdn">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#">
                                    <div class="user_img"><img src="/template/admin/images/1.png" alt=""></div>
                            ...
                            <li class="odd"><a href="#">
                                    <div class="user_img"><img src="/template/admin/images/2.png" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                            ...
                            <li><a href="#">
                                    <div class="user_img"><img src="/template/admin/images/3.png" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="/template/admin/images/a.png" alt=""> </span>
                                <div class="user-name">
                                    <p>Wikolia</p>
