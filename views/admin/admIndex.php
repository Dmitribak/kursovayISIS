    ...
    <div class="main-page">
        ...
        <div class="row">
            <div class="col-md-8 map widget-shadow">
                ...
                <!--map js-->
                <link href="/template/admin/css/jqvmap.css" rel='stylesheet' type='text/css' />
                <script src="/template/admin/js/jquery.vmap.js"></script>
                <script src="/template/admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
                <script src="/template/admin/js/jquery.vmap.world.js" type="text/javascript"></script>
